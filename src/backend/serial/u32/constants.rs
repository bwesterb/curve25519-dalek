...
pub(crate) const SQRT_ID: FieldElement2625 = FieldElement2625([
    39590805, 701138,   28659366, 23623507, 53932708,
    32206357, 36326585, 24309414, 26167230,  1494357,
])

/// `= (d+1)/(d-1)`, where `d` is the Edwards curve parameter.
pub(crate) const DP1_OVER_DM1: FieldElement2625 = FieldElement2625([
...
pub(crate) const MDOUBLE_INVSQRT_A_MINUS_D: FieldElement2625 = FieldElement2625([
...
/// and `i = +sqrt(-1)`.
pub(crate) const MIDOUBLE_INVSQRT_A_MINUS_D: FieldElement2625 = FieldElement2625([
...
pub(crate) const INVSQRT_ONE_PLUS_D: FieldElement2625 = FieldElement2625([
